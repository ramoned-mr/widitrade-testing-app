<div class="modal fade" id="edit{{entity_name}}Modal" tabindex="-1" aria-labelledby="edit{{entity_name}}ModalLabel" aria-hidden="true"
     data-backdrop="static" data-mdb-keyboard="false">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable edit-entity-dialog">
        <div class="modal-content edit-entity-content">
            {{ form_start(form, {'attr': {'class': 'needs-validation edit-{{entity_var_singular}}-form','action': path('{{route_prefix}}_edit',{'id':{{entity_var_singular}}.id})}}) }}
            <div class="modal-header edit-entity-header">
                <h5 class="modal-title" id="edit{{entity_name}}ModalLabel">Actualizar {{entity_name}}</h5>
...
<div data-mdb-ripple-init data-mdb-modal-init data-mdb-target="#edit{{entity_name}}Modal" class="modalDispatcher"></div>